...
<div class="container">
  <form method="post" action="{{action('CustomerController@update', $id)}}">
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control form-control-lg" id="lgFormGroupInput" placeholder="name" name="name" value="{{$customer->name}}">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea name="firstname" rows="8" cols="80">{{$customer->firstname}}</textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea name="adress" rows="8" cols="80">{{$customer->adress}}</textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea name="phone" rows="8" cols="80">{{$customer->phone}}</textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea name="email" rows="8" cols="80">{{$customer->email}}</textarea>
      </div>
    </div>
